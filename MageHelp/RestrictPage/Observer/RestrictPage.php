<?php
namespace MageHelp\RestrictPage\Observer;
...
use \MageHelp\RestrictPage\Helper\Data;
...
class RestrictPage implements ObserverInterface
{
	...
	public function execute(Observer $observer)
	{
		...
		$message = 'Para visualizar essa página você deverá entrar com o usuário e senha !';
		$loginUrl = $this->_urlInterface->getUrl(
			'customer/account/login',
					array('referer' => base64_encode($currentUrl))
		);

		if ($urlToCheck === $currentUrl || $urlToCheck.'/' === $currentUrl) {
